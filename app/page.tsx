...
const copy = {
  fr: {
    ...
    agents: [
      ...
      { label: "Agent 06", title: "Instagram Growth", desc: "Agents IA qui identifient et attirent des abonnés réels, géolocalisés et qualifiés 24/7.", result: "200 à 800 abonnés réels par mois, sans risque pour le compte.", href: "/instagram-growth", link: "Voir la landing page →", accent: "#E1306C", dim: "rgba(225,48,108,0.10)", border: "rgba(225,48,108,0.22)" },
    ],
  ...
  en: {
    ...
    agents: [
      ...
      { label: "Agent 06", title: "Instagram Growth", desc: "AI agents that identify and attract real, geo-targeted, qualified followers 24/7.", result: "200 to 800 real followers per month, with zero account risk.", href: "/instagram-growth", link: "View landing page →", accent: "#E1306C", dim: "rgba(225,48,108,0.10)", border: "rgba(225,48,108,0.22)" },
    ],
