...
type AnalyticsQualityRow = Record<string, unknown>;
...
export async function GET() {
  try {
    ...
    const { data, error } = await query.returns<AnalyticsQualityRow[]>();
    ...
    return NextResponse.json(
      {
        error: "Quality analytics route failed",
