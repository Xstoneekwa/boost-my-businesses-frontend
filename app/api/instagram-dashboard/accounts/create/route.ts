...
export async function POST(request: Request) {
  try {
    ...
    const deviceUdid = readString(body.device_udid, "emulator-5554").trim();
    ...
    return jsonOk({ account, settings: settingsResult.data, filters: filtersResult.data, template }, 201);
  } catch (error) {
