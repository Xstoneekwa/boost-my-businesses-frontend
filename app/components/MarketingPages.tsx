  ...
  return (
    <main className={styles.page}>
      ...
      <section className={`${styles.section} ${styles.useSection}`}>
        <div className={styles.sectionHead}><Eyebrow>{t.uses.eyebrow}</Eyebrow><h2>{t.uses.title}</h2></div>
