...
function CommercialStyles() {
  return <style>{`
    .commercial-page{width:100%;min-width:0;max-width:1540px;margin:0 auto;padding:22px 22px 56px;color:#f0f0ee;overflow-x:clip}.commercial-section-title{margin:32px 0 14px}.commercial-section-title small,.commercial-queue-heading small,.commercial-discovery-copy small{display:block;color:#fbbf24;font:600 10px 'JetBrains Mono',monospace;letter-spacing:.12em;margin-bottom:6px}.commercial-section-title h2{font:700 23px 'Syne',sans-serif}.commercial-section-title p{color:#737884;margin-top:5px}.commercial-filters{display:grid;grid-template-columns:repeat(6,minmax(120px,1fr));gap:10px;border:1px solid rgba(255,255,255,.08);background:#14161b;border-radius:16px;padding:14px}.commercial-filters label,.commercial-discovery-panel label{display:grid;gap:5px}.commercial-filters label span,.commercial-discovery-panel label span{color:#777d89;font:600 9px 'JetBrains Mono',monospace;letter-spacing:.08em;text-transform:uppercase}.commercial-filters select,.commercial-filters input,.commercial-discovery-panel select,.commercial-discovery-panel input{width:100%;border:1px solid rgba(255,255,255,.09);border-radius:8px;background:#0e1014;color:#dfe1e5;padding:9px 10px;font:inherit;min-width:0}.commercial-search{grid-column:span 2}.commercial-filters button,.commercial-filters>a,.commercial-discovery-panel button{align-self:end;border-radius:8px;padding:10px 14px;text-align:center;text-decoration:none;font-weight:700}.commercial-filters button,.commercial-discovery-panel button{border:0;background:#6558f5;color:white;cursor:pointer}.commercial-discovery-panel button:disabled{opacity:.55;cursor:not-allowed}.commercial-filters>a{border:1px solid rgba(255,255,255,.09);color:#a9aeba}.commercial-discovery-panel{border:1px solid rgba(251,191,36,.18);background:linear-gradient(135deg,rgba(251,191,36,.045),#14161b 45%);border-radius:16px;padding:16px}.commercial-discovery-copy h3{font:700 18px 'Syne',sans-serif}.commercial-discovery-copy p{color:#858b96;margin-top:5px}.commercial-discovery-panel form{display:grid;grid-template-columns:1fr 1.2fr .6fr auto;gap:10px;margin-top:14px}.commercial-discovery-summary{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}.commercial-discovery-summary span{padding:7px 9px;border-radius:8px;background:rgba(255,255,255,.04);color:#8c929d;font-size:11px}.commercial-discovery-summary b{color:#f0f0ee}.commercial-discovery-latest{display:flex;align-items:center;gap:9px;flex-wrap:wrap;margin-top:12px}.commercial-discovery-latest small{color:#6e7480}.commercial-discovery-error{color:#f87171;margin-top:10px}.commercial-queues{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:14px}.commercial-queue-card,.commercial-breakdown,.commercial-leads-card{border:1px solid rgba(255,255,255,.08);background:#15171c;border-radius:16px;padding:15px;min-width:0}.commercial-queue-heading{display:flex;justify-content:space-between;gap:10px;align-items:flex-start;margin-bottom:12px}.commercial-queue-heading h3,.commercial-breakdown h3{font:700 16px 'Syne',sans-serif}.commercial-queue-heading>strong{display:grid;place-items:center;width:28px;height:28px;border-radius:50%;background:rgba(101,88,245,.16);color:#a99fff}.commercial-queue-list{display:grid;gap:7px}.commercial-queue-list>a{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:10px;border-radius:9px;background:rgba(255,255,255,.035);color:#eef0f2;text-decoration:none}.commercial-queue-list>a>span:first-child{display:grid;gap:3px;min-width:0}.commercial-queue-list strong{overflow:hidden;text-overflow:ellipsis}.commercial-queue-list small{color:#727885;font-size:11px}.commercial-queue-meta{display:flex;gap:7px;align-items:center}.commercial-empty{border:1px dashed rgba(255,255,255,.1);border-radius:10px;padding:18px;color:#686e79;line-height:1.5;text-align:center}.commercial-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.commercial-two-col{display:grid;grid-template-columns:minmax(0,.8fr) minmax(0,1.2fr);gap:12px;margin-top:12px}.commercial-primary-metric{display:flex;align-items:baseline;gap:12px;min-height:100px}.commercial-primary-metric strong{font:800 54px 'Syne',sans-serif;color:#fbbf24}.commercial-primary-metric span{color:#a9adb5}.commercial-funnel{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:6px}.commercial-funnel>div{display:grid;gap:5px;position:relative;padding:11px;border-radius:9px;background:rgba(255,255,255,.035)}.commercial-funnel>div>span{position:absolute;left:-8px;top:35%;color:#555b67}.commercial-funnel strong{font-size:11px;color:#a8adb8}.commercial-funnel b{font:800 25px 'Syne',sans-serif}.commercial-funnel small{font-size:9px;line-height:1.35;color:#666c78}.commercial-breakdowns{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.commercial-breakdown:last-child{grid-column:span 2}.commercial-breakdown h3{margin-bottom:12px}.commercial-table-scroll{overflow:auto}.commercial-table-scroll table{width:100%;border-collapse:collapse;white-space:nowrap;font-size:11px}.commercial-table-scroll th{text-align:left;color:#626875;font:600 9px 'JetBrains Mono',monospace;letter-spacing:.06em;text-transform:uppercase;padding:9px;border-bottom:1px solid rgba(255,255,255,.08)}.commercial-table-scroll td{padding:10px 9px;border-bottom:1px solid rgba(255,255,255,.05);color:#abb0b9}.commercial-table-scroll tbody tr:last-child td{border-bottom:0}.commercial-table-scroll td:first-child{color:#eef0f2}.commercial-table-scroll td>a{display:grid;gap:3px;color:#eef0f2;text-decoration:none}.commercial-table-scroll td>a small{color:#686e79}.commercial-badge{display:inline-flex;border-radius:999px;padding:4px 7px;background:rgba(147,197,253,.09);color:#93c5fd;font-size:9px;font-weight:700;white-space:nowrap}.commercial-badge-urgent,.commercial-badge-rejected,.commercial-badge-lost,.commercial-badge-failed{background:rgba(248,113,113,.1);color:#f87171}.commercial-badge-high,.commercial-badge-qualified,.commercial-badge-sales_qualified,.commercial-badge-demo_booked,.commercial-badge-running,.commercial-badge-partial{background:rgba(251,191,36,.1);color:#fbbf24}.commercial-badge-approved,.commercial-badge-paid,.commercial-badge-active_client,.commercial-badge-replied,.commercial-badge-completed{background:rgba(52,211,153,.1);color:#34d399}.commercial-pagination{display:flex;justify-content:space-between;align-items:center;margin-top:14px}.commercial-pagination a,.commercial-pagination span{border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:8px 11px;color:#9298a3;text-decoration:none}.commercial-pagination span{opacity:.35}.commercial-pagination b{font-size:11px;color:#686e79}
    ...
    @media(max-width:760px){.commercial-page{padding:18px 14px 40px}.commercial-filters,.commercial-discovery-panel form{grid-template-columns:1fr 1fr}.commercial-search{grid-column:span 2}.commercial-queues,.commercial-kpis,.commercial-two-col,.commercial-breakdowns{grid-template-columns:1fr}.commercial-breakdown:last-child{grid-column:auto}.commercial-funnel{grid-template-columns:repeat(2,minmax(0,1fr))}.commercial-primary-metric strong{font-size:42px}}
