...
type ViewKey = "manage" | "radar" | "server-check" | "devices" | "activity-log" | "dm-templates" | "credentials" | "growth" | "auto-restart" | "client-accounts";
...
const navItems = [
  ...
  { key: "auto-restart", label: "Auto Restart", href: "/instagram-dashboard/auto-restart" },
  { key: "client-accounts", label: "Accounts", href: "/instagram-dashboard/client-accounts" },
] as const;
