...
const COPY: Record<Lang, ActivityCopy> = {
  fr: {
    title: "Activité",
    subtitle: "Suivez les actions réalisées sur votre campagne : comptes ciblés, comptes touchés et résultats.",
    ...
    emptyBody: "Les actions sur vos comptes ciblés apparaîtront ici dès qu'elles seront disponibles.",
    ...
    actions: [
      ...
      { value: "target_add_single", label: "Compte ciblé ajouté" },
      { value: "target_archive", label: "Compte ciblé retiré" },
      { value: "mute_success", label: "Compte protégé" },
    ],
    results: [
  ...
  en: {
    ...
    actions: [
      ...
      { value: "mute_success", label: "Account protected" },
    ],
    results: [
