...
revoke all on function public.begin_client_instagram_onboarding(uuid, uuid, uuid, uuid, uuid, text, text, text, text, jsonb) from public, anon, authenticated;
revoke all on function public.advance_client_instagram_onboarding(uuid, uuid, uuid, text, jsonb) from public, anon, authenticated;
revoke all on function public.restart_client_instagram_onboarding(uuid, uuid, uuid, uuid) from public, anon, authenticated;
revoke all on function public.expire_client_instagram_onboarding_sessions(uuid, uuid) from public, anon, authenticated;
