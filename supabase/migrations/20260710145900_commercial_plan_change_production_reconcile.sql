-- Production reconciliation: plan-change foundation missing on boost-my-businesses-ai (zgafnshkjywfltxgbtzg).
-- Canonical definitions from 20260621120000_commercial_plan_change.sql and
-- 20260622120000_commercial_plan_change_source_revision.sql.
-- Idempotent on existing commercial_checkout_sessions / entitlements data.
-- Must run before Stripe Test foundation migrations.
