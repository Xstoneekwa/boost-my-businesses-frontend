-- Emergency rollback: restore only the pre-fix overview function.
-- Do not replay the full retention migration: it also owns tables, policies,
-- cleanup functions and cron registration outside this patch's scope.
