...
select public.create_or_rearm_follow_60s_canary_control_v1(
  '10000000-0000-4000-8000-000000000007','40000000-0000-4000-8000-000000000002',repeat('a',40),
  50,10,now()+interval '1 day','concurrent-b','com.instagram.android',
  jsonb_build_object(
    'account_id','10000000-0000-4000-8000-000000000007',
  ...
  'concurrent-b','test','sql-concurrency'
);
