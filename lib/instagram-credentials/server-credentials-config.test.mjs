...
test("legacy credentials helper cannot bypass the canonical transaction", () => {
  ...
  assert.match(clientSource, /legacy_direct_create_disabled/);
  assert.doesNotMatch(clientSource, /resolveServerCredentialsConfig/);
  ...
  assert.doesNotMatch(adminCreateSource, /resolveServerCredentialsConfig/);
