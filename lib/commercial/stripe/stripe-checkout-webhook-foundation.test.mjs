    ...
    subscriptions: {
      async retrieve(id) {
        ...
        return {
          ...
          status: "active",
          livemode: false,
          metadata: calls.checkoutCreate.at(-1)?.payload.subscription_data?.metadata ?? {},
          items: { data: [] },
        };
      },
    },
...
describe("stripe test webhook foundation v1", () => {
  ...
  it("paid existing-account checkout binds the exact entitlement and preserves legacy history", async () => {
    ...
    db.tables.commercial_stripe_subscriptions.push({
      id: "subscription-created-before-checkout",
      client_id: "client-1",
      stripe_subscription_id: "sub_existing_paid",
