...
test("client and admin routes import the shared canonical onboarding engine", () => {
  const clientSource = source("../../app/api/instagram-client/onboarding/route.ts");
  ...
  assert.match(clientSource, /canonical-account-onboarding/);
  assert.match(adminSource, /canonical-account-onboarding/);
  assert.match(clientSource, /beginInstagramAccountOnboarding/);
  assert.match(adminSource, /beginInstagramAccountOnboarding/);
