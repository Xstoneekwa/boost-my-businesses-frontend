...
import { isTerminalClientConnectProgress } from "./connect-operation-state.ts";
...
test("connect progress maps canonical account verification without dashboard action", () => {
  const status = mapProgressToClientConnectStatus({
    accountId: "acc-1",
