...
test("client avatar proxy route enforces tenant ownership", () => {
  ...
  assert.match(routeSource, /avatar_url/);
...
test("TargetAvatar component uses client proxy and fallback", () => {
  ...
  assert.match(componentSource, /clientTargetAvatarProxyPath/);
  assert.match(componentSource, /targetId \? clientTargetAvatarProxyPath/);
