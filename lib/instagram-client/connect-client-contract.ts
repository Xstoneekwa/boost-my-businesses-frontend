...
export function clientConnectMessage(status: ClientConnectStatus, lang: "fr" | "en" = "fr") {
  const fr: Record<ClientConnectStatus, string> = {
    ...
    wrong_password: "Instagram a refusé les identifiants de ce compte. Mettez à jour le mot de passe pour reprendre la connexion en toute sécurité.",
    verification_required: "Instagram demande une vérification avant de terminer la connexion de votre compte.",
    verification_code_accepted: "Code enregistré. Nous préparons la reprise de la connexion.",
    verification_resume_active: "Vérification en cours. Nous reprenons la connexion automatiquement.",
  ...
  const en: Record<ClientConnectStatus, string> = {
    ...
    wrong_password: "Instagram rejected this account's credentials. Update the password to resume the connection securely.",
    verification_required: "Instagram requires verification before your account connection can finish.",
    verification_code_accepted: "Code saved. We are preparing to resume the connection.",
    verification_resume_active: "Verification in progress. We are resuming the connection automatically.",
