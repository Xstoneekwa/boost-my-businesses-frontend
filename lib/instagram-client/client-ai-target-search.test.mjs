...
test("AI wizard supports verify selection before validate", () => {
  ...
  assert.match(wizardSource, /verifySelection/);
  assert.match(wizardSource, /pendingVerification/);
  assert.match(wizardSource, /verificationStatus === "found"/);
});
