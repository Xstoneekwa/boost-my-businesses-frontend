...
export const SCHEDULER_REASON_CONTRACT: Record<string, ReasonDescriptor> = {
  ...
  welcome_real_send_disabled: { label: "welcome DM real send disabled", kind: "config" },
  outreach_real_send_disabled: { label: "outreach DM real send disabled", kind: "config" },
  welcome_template_missing: { label: "welcome template missing", kind: "config" },
  outreach_template_missing: { label: "outreach template missing", kind: "config" },
  dm_legacy_gate_mismatch: { label: "DM legacy gate mismatch", kind: "config" },
  dispatcher_launch_disabled: { label: "dispatcher launch disabled", kind: "config" },
  credentials_review_required: { label: "credentials review required", kind: "business" },
  login_verification_required: { label: "login verification required", kind: "business" },
  identity_mismatch_review_required: { label: "identity mismatch review required", kind: "business" },
  follow_warmup_pending: { label: "follow warmup pending", kind: "business" },
  follow_day_quota_exhausted: { label: "follow day quota exhausted", kind: "business" },
  no_executable_phase: { label: "no executable phase", kind: "business" },
  scheduler_launch_blocked: { label: "scheduler launch blocked", kind: "config" },
  ...
  late_preflight_retry_cap_exceeded: { label: "late preflight retry cap exceeded", kind: "technical" },
  ...
  device_locked: { label: "device locked", kind: "business" },
  device_locked_requires_operator: { label: "secure lock requires operator", kind: "business" },
  actual_logged_in_username_not_detected: { label: "username not detected", kind: "business" },
  login_screen_detected: { label: "login screen detected", kind: "business" },
  checkpoint: { label: "checkpoint", kind: "business" },
  login_challenge: { label: "challenge", kind: "business" },
  post_login_popup_detected: { label: "post-login popup", kind: "business" },
