...
export const SCHEDULER_REASON_CONTRACT: Record<string, ReasonDescriptor> = {
  ...
  eligible_safe_boundary_restart: { label: "safe restart ready", kind: "business" },
  no_partial_run_to_resume: { label: "no partial run to resume", kind: "business" },
  partial_run_resume_needed: { label: "partial run needs resume", kind: "business" },
  historical_partial_run_requires_safe_boundary: { label: "safe boundary required", kind: "business" },
  no_safe_restart_strategy: { label: "no safe restart strategy", kind: "business" },
  no_safe_target_plan_available: { label: "no safe target plan", kind: "business" },
  run_in_progress: { label: "run already active", kind: "business" },
  quota_exhausted: { label: "quota exhausted", kind: "business" },
  ...
  manual_only: { label: "manual only", kind: "business" },
  manual_stop_requested: { label: "manual stop requested", kind: "business" },
  planned_future_window: { label: "planned window not open", kind: "business" },
  current_window_closed: { label: "current window closed", kind: "business" },
  ...
  login_identity_not_verified: { label: "login identity not verified", kind: "business" },
