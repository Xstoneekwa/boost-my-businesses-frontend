...
const migration = readFileSync(
  new URL("../../supabase/migrations/20260809232913_unfollow_limit_provenance_and_canonical_onboarding_defaults_v1.sql", import.meta.url),
  "utf8",
);
const rollback = readFileSync(
  new URL("../../supabase/rollback/20260809232913_unfollow_limit_provenance_and_canonical_onboarding_defaults_v1.down.sql", import.meta.url),
  "utf8",
);
