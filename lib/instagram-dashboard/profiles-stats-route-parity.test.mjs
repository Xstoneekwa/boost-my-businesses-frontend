...
test('actual full Profiles → Live → Stats routes use the same account-scoped canonical snapshots',async()=>{
 ...
 const common={'@/lib/supabase':{createSupabaseClient:()=>db},'@/app/instagram-dashboard/manage-data':{getManageData:async()=>({allAccounts:accounts,activeAccounts:accounts,archivedAccounts:[],trashedAccounts:[],summary:{},errors:[]})},'../_utils':utils,'../compass/relay-auth':auth};
 ...
 const request=new Request('http://fixture/profiles?account_ids=a,b,deleted');
